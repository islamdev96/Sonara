...
export const i18n = {
  en: {
    ...
    engineActive: 'Engine: Active — built-in, no extra software',
    engineProcessing: 'Engine: Processing — built-in, no extra software',
    engineInstalled: 'Engine: Installed — reboot or play audio to start',
    engineMissing: 'Engine: Not installed — boost limited to 100%',
  ...
  ar: {
    ...
    engineActive: 'المحرك: مفعّل — مدمج بدون برامج إضافية',
    engineProcessing: 'المحرك: يعالج الصوت — مدمج وبدون برامج إضافية',
    engineInstalled: 'المحرك: مثبت — أعد التشغيل أو شغّل صوتاً للبدء',
    engineMissing: 'المحرك: غير مثبّت — التضخيم محدود بـ 100%',
